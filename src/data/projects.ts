...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "This projects explores the bank marketing dataset using automatic EDA packages in R. The objective is to figure out the frequency of customers using which type of accounts so that new bank offers are offered to most loyal customers.",
    githubUrl: "https://github.com/danialkhilji/Bank-Marketing-EDA",
  },
  {
    title: "Human Activity data analysis (EDA)",
    description:
      "This project is a data analysis of human activity throughout the day using automatic EDA packages in R. The data was collected using the smart phone and smart watch sensors. The results show useful insights to how a human body movement varies at times.",
    githubUrl: "https://github.com/danialkhilji/Human-Activity-EDA",
  },
  {
    title: "Letter Recognition using Machine Learning",
    description:
      "Code is written in Python for recognition of each letter seperately. The project was carried out twice using different algorithms each time. XGBoost and KNN algorithms were used.",
    githubUrl: "https://github.com/danialkhilji/Letter-Recognition",
  },
  {
    title: "House Prices Analysis (EDA)",
    description:
      "This project aims to do a exploratory data analysis of house prices in America. Another aim of this project is to do the analysis in shortest time therefore automatic EDA packages are used. The analysis figures out some trends of how prices vary throughout the year and which options in the house increases its value over time.",
    githubUrl: "https://github.com/danialkhilji/House-Prices-EDA",
  },
  {
    title: "Sentiment Analysis of Mall Customers",
    description:
      "It is a Exploratory Data Analysis (EDA) of mall customers dataset in order to do sentiment analysis. The original dataset was downloaded from Kaggle. The objective of this analysis is to use and explore the Automatic EDA packages in R and analyse dataset. It explores how customers spending power varies according to their age and other variables.",
    githubUrl: "https://github.com/danialkhilji/Sentiment-EDA",
  },
  {
    title: "NETFLIX Movie Recommendation",
    description:
      "Used NETFLIX Competition dataset and cleaned for analysis. Then I used Collaborative Filtering and Pearsons' R Correlation as two methods of recommendation to build a model. Evaluated performance at the end.",
    githubUrl:
  ...
  },
  {
    ...
    description:
      "A buck converter is a form of DC-DC converter which steps down the voltage while increasing the current. Buck converter is attached with the feedback voltage from load so that whenever the load voltages varies the duty cycle accordingly to keep load voltage close to the desired value. In the project, TL494 IC is used to provide PWM signal to the circuit in which Vcc is supplied 12V and DTC is kept at ground. The 2K resistor is attached to the RT and 0.01uF capacitor is attached to the CT pins of the IC. Reference voltage of 5V is sent to the REF pin, using voltage divider, from the 1IN+ pin. The transistor used for switching is IRC530 MOSFET and its PWM is given from C1 pin of TL 494 IC which is the collector pin of the BJT output 1. The load resistor is of 2.5 Ohm and the freewheeling capacitor is a 470uF.",
  },
  {
    title: "Digit recognition from 0-9 using deep neural network",
    description:
      "The main objective of this project was to design and implement a deep neural network for the recognition of the digit ranging from 0 to 9. Network is fed with images of the hand written digits and the network gives the highest output at a particular node according to the digit recognized. There are many available activation functions like sigmoid, Tanh, Relu, Leaky Relu etc. If the problem is a classification problem, the most common choice of activation function is sigmoid. Neural network and libraries were implemented in Jupyter Notebook. The network was gave the results with the 97.22% accuracy.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Designed and implemented a basic microwave oven controller. The controller consists of predefined recipes to select and one can also set the values manually. The output of the controller is displayed on a LCD display and the buzzer is used to notify the user that the food has been cooked while motor is used for rotation of the bottom plate and temperature sensor is used to take temperature values. PIC18F252 microcontroller is used to control all the sensors.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Designed an arithmetic logic unit with 16 functions such as addition, subtraction, multiplication and etc.",
  },
];
