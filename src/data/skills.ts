...
export const technologies: Skill[] = [
  ...
  { label: "Hugging Face", icon: "logos/huggingface-color.svg", iconType: "local" },
  ...
  { label: "OpenCV", icon: "logos/opencv.svg", iconType: "local" },
  { label: "Jupyter", icon: "devicon:jupyter" },
  { label: "Apache Airflow", icon: "devicon:apacheairflow" },
  { label: "Power BI", icon: "logos/power-bi-icon.png", iconType: "local" },
  { label: "Excel", icon: "logos/excel.svg", iconType: "local" },
  { label: "Google Analytics", icon: "logos/google_analytics-icon.svg", iconType: "local" },
  ...
  { label: "Google Gemini Enterprise", icon: "logos/google-gemini-enterprise.svg", iconType: "local" },
  { label: "Tableau", icon: "logos/tableau-icon.svg", iconType: "local" },
  { label: "R Studio", icon: "devicon:rstudio" },
  { label: "Kubeflow", icon: "devicon:kubeflow" },
  { label: "Arduino", icon: "devicon:arduino" },
  { label: "Matlab", icon: "devicon:matlab" },
  { label: "Matlab Simulink", icon: "devicon:matlab" },
  { label: "Google Studio", icon: "logos/google-datastudio.svg", iconType: "local" },
  { label: "Flourish", icon: "logos/flourish-icon-only.svg", iconType: "local" },
